...
# Understand: The shortest sequence is pretty much the BFS
# Vertex is a work, Edges is the transforms of one word to another
# by one letter
# Planning: How do we find neighbor words? 
# For n letters
# take each letter of word
# loop through alphabet change letter with a new one and check