...
You would call `add_friendship()` 500 times for every of the 100 users to have an average of 10 friends each. Every relationship is two sided, with some other user. So all your users 100 multiplied by average of 10 friends each makes 1000. You divide it in half because of the shared relationships leaving you with 500 calls of the function.

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?

Over 60% of the users will be in his extended social network. The average seperation will be between 4 to 5 friends.
